...
export interface ILGSv1Document {
   ...
   */
  emails: Array<ILGSv1Document.Email>;
   ...
   */
  websites: Array<ILGSv1Document.Website>;
   ...
   */
  phone_numbers: Array<ILGSv1Document.PhoneNumber>;
   ...
   */
  id_numbers: Array<ILGSv1Document.IDNumber>;

  /**
   * An array of terms assigned definite meanings within the document.
   */
  terms: Array<ILGSv1Document.Term>;

  /**
   * An array of documents identified within the document.
   */
  external_documents: Array<ILGSv1Document.ExternalDocument>;

  /**
   * An array of quotations within the document.
   */
  quotes: Array<ILGSv1Document.Quote>;
   ...
   */
  dates: Array<ILGSv1Document.Date>;
