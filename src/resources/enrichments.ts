...
export namespace EnrichmentResponse {
  ...
  export namespace Result {
    ...
    export interface Document {
       ...
       * a span of segments.
       */
      crossreferences: Array<Document.Crossreference>;
       ...
       */
      emails: Array<Document.Email>;

      /**
       * An array of documents identified within the document.
       */
      external_documents: Array<Document.ExternalDocument>;
       ...
       */
      id_numbers: Array<Document.IDNumber>;
       ...
       */
      locations: Array<Document.Location>;

      /**
       * An array of legal persons identified in the document.
       */
      persons: Array<Document.Person>;
       ...
       */
      websites: Array<Document.Website>;
    }
    ...
    export namespace Document {
      ...
      export interface Term {
         ...
         * the phrase '"Agreement" means this contract between the parties', the term's
         * name would be the span covering 'Agreement'.
         *
