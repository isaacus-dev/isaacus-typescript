...
import { EnrichmentCreateParams, EnrichmentResponse, Enrichments } from './resources/enrichments/enrichments';
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['ISAACUS_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['ISAACUS_LOG'] or 'warn' if it isn't set.
   */
...
export class Isaacus {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Isaacus.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('ISAACUS_LOG'), "process.env['ISAACUS_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.isaacus.com/v1';
  }
  ...
  static IsaacusError = Errors.IsaacusError;
